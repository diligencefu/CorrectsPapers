...
class TGoodWorkCell: UITableViewCell {
    ...
    func TGoodWorkCellSetValueForGreade(count:NSInteger) {
    ...
    func TGoodWorkCellSetValuesForFirstCorrectDone(model:TShowClassWorksModel) {
        ...
        studentIcon.kf.setImage(with:  URL(string:model.user_photo)!, placeholder: #imageLiteral(resourceName: "photos_image_default"), options: nil, progressBlock: nil, completionHandler: nil)
