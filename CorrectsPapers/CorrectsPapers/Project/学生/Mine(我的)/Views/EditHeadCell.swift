...
class EditHeadCell: UITableViewCell {
    ...
    var chooseIconBlock:((String)->())?  //声明闭包
    ...
    func setTeacherUserIcon(image:UIImage,imgStr:String) {
        
        if imgStr.count > 0 {
            userIcon.kf.setImage(with:  URL(string:imgStr)!, placeholder: #imageLiteral(resourceName: "UserHead_128_default"), options: nil, progressBlock: nil, completionHandler: nil)
        }else {
